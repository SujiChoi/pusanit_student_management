...
public class attend_modify extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					attend_modify frame = new attend_modify(index,name);
	 ...
	 * Create the frame.
	 */
	public attend_modify(int index, String name) {
		...
		JLabel lblNewLabel = new JLabel("Ãâ¼® Á¤º¸ ¼öÁ¤");
		...
		btnNewButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				SQLPusanItMiddleSchool.attend_update(index, name, textArea.getText());
				dispose();
			}
